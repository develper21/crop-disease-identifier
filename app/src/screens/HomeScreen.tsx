...
import { Camera, History, BookOpen, X, Search } from "lucide-react-native";
...
export default function HomeScreen({ navigation }: any) {
  ...
  function handleSearch() {
    if (searchQuery.trim()) {
      navigation.navigate("SearchSolutions");
    }
  }
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.topBar}>
          <Text style={[styles.logo, { color: colors.text }]}>🌱 CropGuard</Text>
          <TouchableOpacity 
            style={[styles.searchButton, { borderColor: colors.primary, backgroundColor: colors.surface }]}
            onPress={() => navigation.navigate("SearchSolutions")}
          >
